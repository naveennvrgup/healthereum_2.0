...
class DatatablePage extends Component {
    ...
    button =()=>{
        if(a===0){
            return(
                <Fragment>
                    <MDBBtn  outline color="success" style={{margin:"20px",color:"white",fontWeight:"bold"}}>Start Session</MDBBtn>
                    <MDBBtn outline color="primary" style={{margin:"20px",color:"white",fontWeight:"bold"}}>View History</MDBBtn>
